...
```
Basado en tiempo de ejecucion el modelo mas eficiante es el modelo de casas baratas tomando un tiempo aprox de 0.073 secs y el mas tardado es el modelo de casas intermedias tomando un tiempo de entrenamiento de 0.095 secs. 
